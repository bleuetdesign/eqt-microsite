...
<div class="mx-auto max-w-screen-xl">
	<div class="bg-[#F4F3E6] px-8">
		...
		<section class="flex">
			...
			<div class="max-w-lg text-xl text-gray-800">
				<p>
	...
	<!-- newsletter signup -->
	<section class="flex-col items-center justify-center gap-y-8 bg-[#1f1f1f] py-48">
		<h2 class="mb-8 text-balance text-center text-[2.5rem] font-medium leading-tight text-lime-200">
		...
		<form action="">
			...
			<a
				class="mt-8 block text-center text-lg text-lime-200 underline"
				href="https://www.equiterre.org/">Pour en savoir plus sur Équiterre</a
			>
		</form>
	</section>
</div>
